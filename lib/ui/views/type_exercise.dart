...
class TypeExerciseSelection extends StatefulWidget{
  final String argument;

  const TypeExerciseSelection({Key key, @required this.argument}) : super(key: key);

  @override
  _TypeExerciseSelection createState() => _TypeExerciseSelection();
}

class _TypeExerciseSelection extends State<TypeExerciseSelection> {
  @override
                  ...
                  children: <Widget>[
                    GestureDetector(
                        ...
                        onTap: () {
                          Navigator.pop(
                            context,
                            MaterialPageRoute(builder: (context) => SelezioneGiorno()),
                          );
                        }),
                    Text(
                      "FATTO",
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: CatalogListView(entries: type, route: Router.RouteHandler.AttrEserciziRoute),
                      )
                    ],
                  ),
                ),
